...
<template>
  <div class="flex justify-center items-center h-screen">
    ...
    <RouterLink to="/search">
      <button @click="startRotation" data-popover-target="popover-offset" data-popover-offset="30" type="button" class="text-black bg-blue hover:bg-blue focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Démarrer</button>
    </RouterLink>
