...
<div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
    ...
    <button type="button" class="text-white bg-blue hover:bg-blue focus:ring-4 focus:outline-none focus:ring-blue dark:focus:ring-blue font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Choisir cet abonnement</button>
    </div>    
</template>
